export default function DonationReceipt({ receiptData }) {
  ...
  return (
    <div
      className="w-full h-full pt-10 bg-white overflow-hidden relative"
      style={{ border: "7px solid #006400 !important" }}
    >
      {/* Header Section */}
      <div className="text-center border-b border-green-600 pb-4 mb-4 ml-10 mr-10">
                ...
                <div key={index} className="flex items-center space-x-2">
                  ...
                  >
                    ...
                    <g id="SVGRepo_iconCarrier">
                      <rect x="1" y="1" width="14" height="14" fill="#33a373" />
                    </g>
                  </svg>
      ...
      {/* { Footer} */}
      <div className="w-full pb-10 pt-36">
        {/* Thank You Section */}
        <div className="w-full flex justify-center items-center mt-8 text-2xl font-bold font-[cursive]">
          <p>Thank You!</p>
        </div>

        {/* Signature Section */}
        <div className="flex flex-col items-end justify-end pr-12 gap-3 mt-4">
          {/* <img
          ...
          <img
            ...
            alt="Signature"
            className="h-20 w-40"
            style={{ backgroundColor: "white" }} // Match the surrounding background
          />
          <p className="pr-5 font-bold text-black">Authorized Signatory</p>
        ...
        {/* Footer Section */}
        <div className="flex justify-center items-center mt-6 border-t border-green-600 pt-4">
