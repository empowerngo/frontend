export default function DonationReceipt({ receiptData }) {
  ...
  return (
    <div className="w-[684px] h-full bg-white overflow-hidden relative m-20 ">
      <div className="border-8 border-[#006400] pt-[2px]">
        ...
        <div className="grid grid-cols-2 gap-6 text-sm text-gray-700 font-light pl-20 pr-20">
          {[
            ["Receipt:", exam.receiptNumber],
            ["Date:", formatDate(exam.donationDate)],
            ["Name:", `${exam.donorFName} ${exam.donorLName}`],
            ["Address:", exam.donorAddress || "Not Provided"],
            ["Mobile:", exam.donorMobile],
            ["PAN:", exam.donorPAN],
            ["Email:", exam.donorEmail || "Not Available"],
            ["Amount:", exam.amount],
            ["Amount in words:", exam.amountInWords || "Not Specified"],
            ["Payment Method:", exam.type],
            ["Transaction ID:", exam.transactionID || "Not Available"],
            ["Transaction Date:", formatDate(exam.crDate) || "Not Available"],
            ["Bank Name:", exam.bank],
            ["Project:", exam.project],
            ["Purpose:", exam.purpose],
            ["Generated By:", `${parsedData.FNAME} ${parsedData.LNAME}`],
            ["Note:", exam.note || "No Additional Notes"],
