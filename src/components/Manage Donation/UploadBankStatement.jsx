      ...
      <div className="flex flex-row justify-between items-center w-full mb-4 h-full">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg transition border-none ${
              !hideContainer
        ...
        <>
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 w-full">
            ...
            <button
              ...
              className="w-full md:w-1/6 bg-blue-900 text-white rounded-xl px-4 py-3 hover:bg-blue-800 transition"
            >
              Import
            </button>
          </div>
